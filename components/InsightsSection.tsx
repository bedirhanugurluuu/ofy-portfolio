...
import { Project, normalizeImageUrl, isSupabaseImage, shouldUnoptimizeImage } from "@/lib/api";
                            ...
                            <div className="flex-shrink-0">
                                <div className="w-[70px] h-[70px] md:w-[90px] md:h-[90px] relative overflow-hidden" style={{ aspectRatio: '1 / 1' }}>
                                    ...
                                    project.thumbnail_media.toLowerCase().endsWith('.webm') ? (
                                        ...
                                        unoptimized={shouldUnoptimizeImage(normalizeImageUrl(project.thumbnail_media))}
                                        />
                                    )
                                    ) : (
