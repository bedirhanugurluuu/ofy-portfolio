...
import { SliderItem, normalizeImageUrl, isSupabaseImage, shouldUnoptimizeImage } from "@/lib/api";
      ...
      <div className="relative">
        ...
        <div className="relative w-full aspect-[.7090909090909091/1] md:aspect-[2.230769230769231/1]">
          <Image
            ...
            sizes="100vw"
            unoptimized={shouldUnoptimizeImage(normalizeImageUrl(currentItem.image_path || ''))}
                ...
                {/* Thumbnail image */}
                 <div className={`w-33 h-22 overflow-hidden transition-all duration-300 ${
                  ...
                  <Image
                     ...
                     unoptimized={shouldUnoptimizeImage(normalizeImageUrl(item.image_path || ''))}
